...
public class DBInitializer {
	...
	private static void initChampionshipTable(){
		
	}
	
	private static void initClaxTable(){
	...
	private static void initTeamTable(){
		
	}

	private static void initCircuitTable(){
	...
	private static void initSponsorTable(){
	...
	private static void initMemberTable(){
