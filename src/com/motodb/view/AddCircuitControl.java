...
public class AddCircuitControl extends ScreenControl {
    ...
    public void initialize() {
        ...
        championshipManager.getChampionships()
                .forEach(l -> recordYearBox.getItems().add(Integer.toString(l.getYear())));
    ...
    private void add() {
        try {
            if (recordField.getText() != null && recordRiderBox.getSelectionModel().getSelectedItem() != null
                    && recordYearBox.getSelectionModel().getSelectedItem() != null) {
                circuitManager.addCircuit(nameField.getText(), stateField.getText(), locationField.getText(),
                        Integer.parseInt(rightHandersField.getText()), Integer.parseInt(leftHandersField.getText()),
                        Integer.parseInt(lenghtField.getText()), Integer.parseInt(straightField.getText()),
                        photoField.getText(), Optional.of(recordField.getText()),
                        Optional.of(recordRiderBox.getSelectionModel().getSelectedItem().getPersonalCode()),
                        Optional.of(Integer.parseInt(recordYearBox.getSelectionModel().getSelectedItem())));
            } else if (recordField.getText().isEmpty() && recordRiderBox.getSelectionModel().isEmpty()
                    && recordYearBox.getSelectionModel().isEmpty()) {
                circuitManager.addCircuit(nameField.getText(), stateField.getText(), locationField.getText(),
                        Integer.parseInt(rightHandersField.getText()), Integer.parseInt(leftHandersField.getText()),
                        Integer.parseInt(lenghtField.getText()), Integer.parseInt(straightField.getText()),
            ...
            circuitTable.setItems(circuitManager.getCircuits()); // Update table
                                                                 // view
            this.clear();
        } catch (Exception e) {
            e.printStackTrace();
