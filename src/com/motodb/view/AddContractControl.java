...
public class AddContractControl extends ScreenControl {
    ...
    private void add() {
        try {
            ...
            contractTable.setItems(contractManager.getContracts()); // Update
                                                                    // table
                                                                    // view
            this.clear();
        } catch (Exception e) {
    ...
    private void update() {
        ...
        yearBox.getSelectionModel().selectedItemProperty().addListener(((observable, oldValue, newValue) -> {
            if (newValue != null) {
                ...
                teamBox.setItems(
                        FXCollections.observableArrayList(teamManager.getTeamsFromYear(Integer.parseInt(newValue))));
            } else {
                teamBox.setDisable(true);
                classBox.setDisable(true);
            }
