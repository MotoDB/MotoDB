...
public class GUI extends Application implements GuiInterface {
    ...
    public void start(Stage splashStage) throws IOException {
        ...
        // Initializing the splash screen, first making a layout and adding the
        // image to it
        StackPane splashLayout = new StackPane();
        splashLayout.setStyle("-fx-background-color: transparent;");
        splashLayout.getChildren().add(splash);
        // Then making a new transparent scene with the image in it, big as the
        // image
        ...
        // Initializing the actual main stage, first creating the full-screen
        // scene
        ...
        final int fontSize = 10; // This value is not needed, as it will be
                                 // overrided by CSS
        ...
        // Loading the movements pane, which will be the welcome page, as it's
        // the most used one
        URL movementsUrl = getClass().getResource("worldStanding.fxml");
